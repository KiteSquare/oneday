...
public class ConfigConstant {
    public static final Integer COOKIE_EXPIER_TIME = 31104000;//1年
    public static final String COOKIE_USERINFO_KEY = "_u";//
    public static final String SDKTOKEN = "VXNdMLEBBk";//
